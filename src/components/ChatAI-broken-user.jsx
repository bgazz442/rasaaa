  ...
  const sendMessage = useCallback(async () => {
    ...
    try {
      ...
      const errorMsg = {
        id: Date.now() + 2,
        role: 'assistant',
        content: error.message || 'Maaf, lagi ada kendala. Kalau urgent, hubungi WhatsApp +62 812 9281 6844 ya.',
        isTyping: false,
        isNew: false
      };
          ...
          >
            ...
            <div className="px-4 py-3 border-b border-white/10 flex justify-between items-center bg-black/20 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-semibold text-[14px] font-sans">Selarasa AI</h3>
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Header */}
        <div 
          className="px-4 py-3 border-b border-white/10 flex justify-between items-center bg-black/20 shrink-0"
